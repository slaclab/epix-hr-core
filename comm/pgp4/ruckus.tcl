...
if { [info exists ::env(INCLUDE_PGP4_10G)] != 1 && [info exists ::env(INCLUDE_PGP4_6G)] != 1 && [info exists ::env(INCLUDE_PGP4_3G)] != 1 } {
   puts "\n\nERROR: The PGP3 link speed (INCLUDE_PGP4_10G or INCLUDE_PGP4_6G or INCLUDE_PGP4_3G) is not defined in $::env(PROJ_DIR)/Makefile\n\n"; exit -1
}
