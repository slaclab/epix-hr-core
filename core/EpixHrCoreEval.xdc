...
set_property PACKAGE_PIN M25 [get_ports {qsfpClkP}]
set_property PACKAGE_PIN M26 [get_ports {qsfpClkN}]
...
set_property PACKAGE_PIN P6 [get_ports {ddrClkP}] 
set_property PACKAGE_PIN P5 [get_ports {ddrClkN}] 
