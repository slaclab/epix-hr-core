...
set_property -dict { PACKAGE_PIN D2 IOSTANDARD LVCMOS18 } [get_ports {snIoAdcCard}]
set_property -dict { PACKAGE_PIN D1 IOSTANDARD LVCMOS18 } [get_ports {snIoCarrier}]
...
set_property -dict { PACKAGE_PIN B2 IOSTANDARD LVCMOS18 } [get_ports {qsfpLpMode}]
set_property -dict { PACKAGE_PIN B1 IOSTANDARD LVCMOS18 } [get_ports {qsfpModSel}]
set_property -dict { PACKAGE_PIN A4 IOSTANDARD LVCMOS18 } [get_ports {qsfpInitL}]
set_property -dict { PACKAGE_PIN A3 IOSTANDARD LVCMOS18 } [get_ports {qsfpRstL}]
set_property -dict { PACKAGE_PIN M2 IOSTANDARD LVCMOS18 } [get_ports {qsfpPrstL}]
set_property -dict { PACKAGE_PIN M1 IOSTANDARD LVCMOS18 } [get_ports {qsfpScl}]
set_property -dict { PACKAGE_PIN H2 IOSTANDARD LVCMOS18 } [get_ports {qsfpSda}]

# DDR Ports

set_property PACKAGE_PIN M25 [get_ports {ddrClkP}] 
set_property PACKAGE_PIN M26 [get_ports {ddrClkN}] 

set_property PACKAGE_PIN AG15 [get_ports {ddrBg}] 
set_property PACKAGE_PIN AE15 [get_ports {ddrCkP}] 
set_property PACKAGE_PIN AE16 [get_ports {ddrCkN}] 
...
set_property PACKAGE_PIN AH21 [get_ports {ddrDqsP[0]}] 
set_property PACKAGE_PIN AG21 [get_ports {ddrDqsN[0]}] 
set_property PACKAGE_PIN AJ25 [get_ports {ddrDqsP[1]}] 
set_property PACKAGE_PIN AH24 [get_ports {ddrDqsN[1]}] 
set_property PACKAGE_PIN AK20 [get_ports {ddrDqsP[2]}] 
set_property PACKAGE_PIN AJ20 [get_ports {ddrDqsN[2]}] 
set_property PACKAGE_PIN AP21 [get_ports {ddrDqsP[3]}] 
set_property PACKAGE_PIN AP20 [get_ports {ddrDqsN[3]}] 

set_property -dict { PACKAGE_PIN H1 IOSTANDARD LVCMOS18 } [get_ports {ddrPg}]
set_property -dict { PACKAGE_PIN D6 IOSTANDARD LVCMOS18 } [get_ports {ddrPwrEn}]
